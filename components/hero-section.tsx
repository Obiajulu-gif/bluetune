			...
			<div className="container mx-auto px-4 relative z-10">
				<div className="flex flex-col md:flex-row items-center gap-12">
					<div className="flex-1 text-center md:text-left">
						...
						>
							Own your music, support artists directly, and experience the
							future of music streaming on the Sui blockchain.
						</motion.p>
						...
						>
							<div className="text-center">
								<div className="text-purple-400 font-bold text-2xl">10K+</div>
								<div className="text-gray-400 text-sm">Tracks</div>
							</div>
							<div className="text-center">
								<div className="text-blue-400 font-bold text-2xl">2K+</div>
								<div className="text-gray-400 text-sm">Artists</div>
							</div>
							<div className="text-center">
								<div className="text-green-400 font-bold text-2xl">45K+</div>
